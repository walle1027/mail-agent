...
export const BranchSelector = ({ className, from, ...props }: BranchSelectorProps) => {
  ...
  return <div className={cn('flex items-center gap-2 self-end px-10', from === 'assistant' ? 'justify-start' : 'justify-end', className)} {...props} />
}
...
export const BranchPrevious = ({ className, children, ...props }: BranchPreviousProps) => {
  ...
  return (
    <Button
      ...
      className={cn('size-7 shrink-0 rounded-full text-muted-foreground transition-colors', 'hover:bg-accent hover:text-foreground', 'disabled:pointer-events-none disabled:opacity-50', className)}
