  ...
  return (
    <div className="relative flex w-full" onDragOver={onDragOver} onDragLeave={onDragLeave} onDrop={onDrop}>
      ...
      <div className="absolute right-3 top-3 z-20 flex gap-2">
        ...
        {isSpeechSupported && (
          <Button type="button" variant="outline" className={cn('h-8 w-8', isListening && 'text-primary')} aria-label="Voice input" size="icon" onClick={toggleListening}>
        ...
        {isGenerating && stop ? (
          ...
          <Button type="submit" size="icon" className="h-8 w-8 transition-opacity" aria-label="Send message" disabled={props.value === '' || isGenerating}>
      ...
      <RecordingControls isRecording={isRecording} isTranscribing={isTranscribing} audioStream={audioStream} textAreaHeight={textAreaHeight} onStopRecording={stopRecording} />
    </div>
  )
}
